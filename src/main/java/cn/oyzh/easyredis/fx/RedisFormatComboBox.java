...
//         this.clearItems();
//         this.addItem(I18nHelper.raw().toUpperCase());
//         this.addItem(I18nHelper.json().toUpperCase());
//         this.addItem(I18nHelper.binary().toUpperCase());
//         this.addItem(I18nHelper.hex().toUpperCase());
//         this.addItem(I18nHelper.string().toUpperCase());
