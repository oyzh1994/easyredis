...
//  */
// @Component
// public class RedisClientListTerminalCommandHandler extends RedisTerminalCommandHandler<TerminalCommand> {
//
//     @Override
...
//         try {
//             String clientList = terminal.client().clientList();
//             result.setResult(RedisTerminalUtil.formatOut(clientList));
//         } catch (Exception ex) {
//             ex.printStackTrace();
