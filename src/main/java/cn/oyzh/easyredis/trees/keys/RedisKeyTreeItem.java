 ...
 * @since 2023/6/30
 */
public abstract class RedisKeyTreeItem extends RedisTreeItem<RedisKeyTreeItemValue> {
    ...
    public RedisKeyTreeItem(@NonNull RedisKey value, RedisKeyTreeView treeView) {
        super(treeView);
        this.value = value;
    }
