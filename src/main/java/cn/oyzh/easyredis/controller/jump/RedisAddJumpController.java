package cn.oyzh.easyredis.controller.jump;
...
@StageAttribute(
        ...
        value = FXConst.FXML_PATH + "jump/redisAddJump.fxml"
)
public class RedisAddJumpController extends StageController {
    ...
    private void testConnect() {
        ...
        if (!StringUtil.isBlank(host)) {
            ...
            RedisConnectUtil.testSSHConnect(this.stage, shellConnect);
        }
    }
    ...
    private void add() {
        ...
        try {
            ...
            RedisJumpConfig config = new RedisJumpConfig();
            config.setName(name);
            config.setPort(port);
            config.setHost(host);
