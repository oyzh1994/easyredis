...
@StageAttribute(
        ...
        value = FXConst.FXML_PATH + "connect/redisExportConnect.fxml"
)
public class RedisExportConnectController extends StageController {
    ...
    private void doExport() {
        ...
        RedisConnectExport export = RedisConnectExport.fromConnects(connects);
        // 分组
