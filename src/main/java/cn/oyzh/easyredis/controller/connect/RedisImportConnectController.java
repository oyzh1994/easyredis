...
import cn.oyzh.easyredis.dto.RedisConnectExport;
...
@StageAttribute(
        ...
        value = FXConst.FXML_PATH + "connect/redisImportConnect.fxml"
)
public class RedisImportConnectController extends StageController {
    ...
    private void doImport() {
        try {
            ...
            RedisConnectExport export = RedisConnectExport.fromJSON(text);
            ...
            List<RedisGroup> groups = export.getGroups();
