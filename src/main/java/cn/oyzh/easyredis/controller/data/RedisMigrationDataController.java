...
public class RedisMigrationDataController extends StageController {
     ...
     * 迁移处理器
     */
    private RedisDataMigrationHandler migrationHandler;
    ...
    private void doMigration() {
        ...
        if (this.migrationHandler == null) {
            this.migrationHandler = new RedisDataMigrationHandler();
        ...
        // 认证信息
        this.migrationHandler.setKeyFilters(this.keyFilters.isSelected());
        // 连接
